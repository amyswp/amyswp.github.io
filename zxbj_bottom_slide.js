                       ...
                       '<div class="con_bj clear">' +
                                        ...
                                        '<div class="form_line">' +
                                            ...
                                            '<div class="element">' +
                                                '<div class="province-town clear">' +
                                                    ...
                                                    '</select>' +
                                                    '<select id="zxys_City" name="city" class="select_City" onchange="changeTown(\'zxys_Shen\',\'zxys_City\',\'zxys_Town\');">' +
                            ...
                            '<div class="con_bj_res col_l">' +
                                ...
                                '<div class="bj_explain zxys_explain" style="display:none">' +
                                    '<p class="attention"><b>*</b>稍候装修管家将回电您，免费提供装修咨询服务</p>' +
                                    '<p><b>*</b>因材料品牌及工程量不同，具体报价以量房实测为准</p>' +
                                '</div>' +                            
                        '</div>' +
                        '<div class="tdc-box"></div>'+
                    '</div>' +
                '</div>' +
